    ...
    implements SharedPreferences.OnSharedPreferenceChangeListener
{
    ...
    private void requestPermissions()
    {
        ...
        /*
        if (((FweService)getApplication()).isCar()) {
        ...
        if (!EasyPermissions.hasPermissions(this, permsArray)) {
            ...
            ((FweService)getApplication()).requestLocationUpdates();
        }*/
    }
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        /*if (((FweService)getApplication()).isCar()) {
            ...
            bluetoothDevicePreference.setOnPreferenceClickListener(preference -> {
                startActivityForResult(new Intent(PreferencesActivity.this, BluetoothActivity.class), REQUEST_BLUETOOTH);
                return false;
            });
            ...
            vehicleNamePreference.setOnPreferenceClickListener(preference -> {
                startActivityForResult(new Intent(PreferencesActivity.this, ConfigureVehicleActivity.class), REQUEST_CONFIGURE_VEHICLE);
                return false;
            });
        }*/
    ...
    public void onAboutClick(View v) {
        startActivityForResult(new Intent(PreferencesActivity.this, AboutActivity.class), REQUEST_ABOUT);
    }
    ...
    Thread mStatusUpdateThread = new Thread(() -> {
        ...
        try
        {
            ...
            {
                Thread.sleep(1000);
                //String status = ((FweService)getApplication()).getStatusSummary();
