...
import { darkNavyText, mediumBlue, white } from "assets/colors";
import amzVehicle from "assets/img/amz_vehicle_new.png";
...
const vehicleTabs = [
  ...
  },
  {
    label: "Status",
    id: "status",
    Comp: React.lazy(() => import("./VehicleStatus"))
  },
  {
    label: "Tires",
    id: "tires",
    Comp: React.lazy(() => import("./VehicleTires"))
  },
  {
    label: "Battery",
    id: "battery",
    Comp: React.lazy(() => import("./VehicleBattery"))
  },
  {
    label: "Trips",
    id: "trips",
    Comp: React.lazy(() => import("./VehicleTrips"))
  }
];
...
const VehicleTabsContainer = ({
  ...
  const handleSelectTab = tabId => () => {
    setSelectedVehicle({ ...selectedVehicleData, "tabSelected": tabId })
    setSelectedTabId(tabId)
  };
  const viewingDetails = selectedTabId === "details" || "status" || "tires" || "battery";
  const { vin, make, model, year } = selectedVehicleData.device;
  dataCacheRef.current.device = selectedVehicleData;
  const safeVehicleLabel = `${year || ""} ${make || ""} ${model || ""}`;
...
const defaultCache = () => ({ tripHistory: {}, events: {}, device: {} });
